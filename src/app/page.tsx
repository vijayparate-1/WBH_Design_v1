...
type ActiveTab = 'stage1' | 'stage2' | 'stage3' | 'summary' | 'projects' | 'insulation' | 'bom';
...
const TABS = [
  { id: 'stage1',     label: '① Gas Properties' },
  { id: 'stage2',     label: '② Firetube Sizing' },
  { id: 'stage3',     label: '③ Process Coil' },
